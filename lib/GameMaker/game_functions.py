import sys
import pygame
from lib.GameMaker.bullet import Bullet
from lib.GameMaker.alien import Alien
...
def update_aliens(ai_settings,aliens,ship,screen,stats,bullets,sb):
    ...
    check_aliens_bottom(ai_settings,screen,aliens,stats,ship,bullets,sb)
...
def get_number_rows(ai_settings,ship_height,alien_height):
    available_space_y=ai_settings.screen_height-(3.5*alien_height)-ship_height
...
def check_aliens_bottom(ai_settings,screen,aliens,stats,ship,bullets,sb):
